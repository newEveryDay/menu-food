...
/* 4 */
/*!*********************************************!*\
  !*** G:/menu-food/menu-book-min/pages.json ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 9 */
/*!*************************************************!*\
  !*** G:/menu-food/menu-book-min/store/index.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 11 */
/*!****************************************************!*\
  !*** G:/menu-food/menu-book-min/services/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _home = _interopRequireDefault(__webpack_require__(/*! ./home */ 12));
var _user = _interopRequireDefault(__webpack_require__(/*! ./user.js */ 19));
var _menu = _interopRequireDefault(__webpack_require__(/*! ./menu.js */ 20));
var _collect = _interopRequireDefault(__webpack_require__(/*! ./collect.js */ 21));
var _guessYouLike = _interopRequireDefault(__webpack_require__(/*! ./guessYouLike.js */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var service = {
  $home: _home.default,
  $user: _user.default,
  $menu: _menu.default,
  $collect: _collect.default,
  $guessYouLike: _guessYouLike.default };var _default =
...
/* 12 */
/*!***************************************************!*\
  !*** G:/menu-food/menu-book-min/services/home.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 13));
var _environment = _interopRequireDefault(__webpack_require__(/*! @/environment.js */ 17));
var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                        ...
                                                                                                                                                        */ // 导入http中创建的axios实例
//根服务url
var options = { baseUrl: _environment.default.SERVERURL + '/home', header: {
    source: 'wx_app' } };



var home = {
  getHomeVideo: function getHomeVideo(params) {
  ...
  /* 获取商家详情 */
  getShop: function getShop(params) {
  ...
  /* 
      ...
      1、拨打电话 2、分享 3、添加微信
      */
  addStatisticCout: function addStatisticCout(params) {
    return http.post('/add_phone_num.yj', params, options);
  },
  getGs: function getGs(params) {
  ...
  /**
      ...
      */
  addLookCount: function addLookCount(params) {
    console.log(params);
  ...
  /**
      ...
      */
  getInitWeChat: function getInitWeChat(params) {
    return http.get('/getWxConfig', params, _baseUrl);

  },
  // 根据微信code获取openId
  getWechatOpenId: function getWechatOpenId(params) {
    return http.get('/wechatOpenIdGet', params, _baseUrl);
  },
  //用户登录时，获取用户信息
  getOperatorByOpenId: function getOperatorByOpenId(params) {
    return http.get('/getOperatorByOpenId', params, _baseUrl);
  },
  //用户注册时，点击“获得验证码”触发获取验证码，在regPage页面调用
  getRegisterCodeOpenId: function getRegisterCodeOpenId(params) {
  ...
  /**
      ...
      * @param id 运营角色id
      */
  operatorRoleGet: function operatorRoleGet(tenantId, name, id) {
    var params = {
      tenantId: tenantId };
  ...
  /**
      ...
      * @param tenantId 商品ID
      */
  getVemsPlan: function getVemsPlan(vemId, params) {
  ...
  /**
      ...
      * @returns {*}
      */
  scanQrcodeToLogin: function scanQrcodeToLogin(vemId, openId) {
    return http.get("/scanQrcodeToLogin/".concat(vemId, "/").concat(openId), {}, _baseUrl);
  },
  /**
      * 获取终端扫码登录的返回地址
      */
  wechatLoginUrl: function wechatLoginUrl() {
  ...
  /**
      ...
      * @param position
      */
  postRealTimeRositions: function postRealTimeRositions(params) {
  ...
  /**
      ...
      * @param operatorId
      */
  getOperatorsPositions: function getOperatorsPositions(params) {
  ...
  /**
      ...
      * @param operatorId 运营角色id
      */
  getLineInfoList: function getLineInfoList(operatorId) {
    return http.get('/lines/getOperatorIdByLine', { operatorId: operatorId }, _baseUrl);
  } };var _default =
...
/* 13 */
/*!*************************************************!*\
  !*** G:/menu-food/menu-book-min/common/http.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var TIME_OUT = '30000';var _default =

{
  ...
  request: function request(options, timeout) {var _this = this;
    if (!options) {
      options = {};
    }
    ...
    "https://")) {
      options.url = _environment.default.SERVERURL + options.url;
    }
  ...
  get: function get(url, data, options, timeout) {
    // debugger;
    if (!options) {
      options = {};
    }
  ...
  post: function post(url, data, options, timeout) {
    if (!options) {
      options = {};
    }
    options.url = url;
  ...
  put: function put(url, data, options, timeout) {
    if (!options) {
      options = {};
    }
    options.url = url;
  ...
  delete: function _delete(url, data, options, timeout) {
    if (!options) {
      options = {};
    }
    options.url = url;
  ...
  formData: function formData(url, params) {
    return formDataRequest(url, params);
  },
  putArray: function putArray(url, params) {
...
function formDataRequest(url, params) {
  return new Promise( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(resolve, reject) {var XHR, formData, k, i, blob, file, newFile;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              XHR = null;
              ...
              XHR) {_context.next = 23;break;}
              formData = new FormData();
              for (k in params.adata) {
                formData.append(k, params.adata[k]);
              }
              i = 0;case 6:if (!(i < params.file.length)) {_context.next = 18;break;}_context.next = 9;return (
                fileRead.getBlobFromUrl(params.file[i]));case 9:blob = _context.sent;
              file = fileRead.blobToFile(blob);_context.next = 13;return (
                fileRead.compress(file));case 13:newFile = _context.sent;
              formData.append('file', newFile);case 15:i++;_context.next = 6;break;case 18:
              ...
              XHR.send(formData);case 23:case "end":return _context.stop();}}}, _callee, this);}));return function (_x, _x2) {return _ref.apply(this, arguments);};}());
...
function putArrayRequest(url, params) {
  return new Promise( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(resolve, reject) {var XHR;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              XHR = null;
              if (window.XMLHttpRequest) {
                // 非IE内核
                XHR = new XMLHttpRequest();
              ...
              }case 3:case "end":return _context2.stop();}}}, _callee2, this);}));return function (_x3, _x4) {return _ref2.apply(this, arguments);};}());
...
/* 17 */
/*!*************************************************!*\
  !*** G:/menu-food/menu-book-min/environment.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var environment = getEnvironmentConfig();var _default =
environment;exports.default = _default;

/***/ }),
/* 18 */
/*!*****************************************************!*\
  !*** G:/menu-food/menu-book-min/common/constant.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.constant = void 0; /**
                                                                                                       * 
                                                                                                       * 静态常量类
                                                                                                       * 所有的在项目中可能用到的常量，都在这里管理
                                                                                                       * 
                                                                                                       * */
var constant = {
  TOKEN: "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiLlsI_otbUiLCJjcmVhdGVkIjoxNTc0ODQ2MjMzMjgyLCJleHAiOjE1NzU0NTEwMzMsInVzZXJJZCI6IjExMjk4MyJ9.PCFYE6j2dqq8Oumhh3udEhPOEqE2yaM9Q-tpUhAOMWkf-n-gvjBomoMqEN56pnG1_MgipB37Xxi6rx1T9gg9Sg", //http的token，在store/index.js的login方法中赋值
  RESULT_CODE: '0000',
  RESULT_CODE_TWO_ZERO: '00' };exports.constant = constant;

/***/ }),
/* 19 */
/*!***************************************************!*\
  !*** G:/menu-food/menu-book-min/services/user.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                        ...
                                                                                                                                                        */ // 导入http中创建的axios实例
//根服务url
var options = { baseUrl: _environment.default.SERVERURL + '/v1', header: {
    source: 'wx_app' } };


console.log(_store.default.state.uid);

var user = {
  getCaseCategory: function getCaseCategory(params) {
    return _http.default.get('/case_category.yj', params, options);
  },
  getCaseList: function getCaseList(params) {
    return _http.default.get('/case_list.yj', params, options);
  },
  // 通过code获取用户信息
  getWXLogin: function getWXLogin(params) {
    return _http.default.post('/token', params, options);
  },
  updataUserInfo: function updataUserInfo(params) {
    return _http.default.post('/user/update', params, options);
  },
  // 获取用户信息
  getUserInfo: function getUserInfo(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.get('/profile.yj', params, options);
  },
  // 获取用户信息
  wxBindPhone: function wxBindPhone(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.post('/wx_bind_phone.yj', params, options);
  },
  // 获取用户信息
  getShopVideoList: function getShopVideoList(params) {
    return _http.default.get('/shop_video_list.yj', params, options);
  },
  // 店铺记录
  getshopRecord: function getshopRecord(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.get('/shop_record.yj', params, options);
  },
  // 添加店铺记录
  lookRecord: function lookRecord(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.post('/look_record.yj', params, options);
  },
  // 添加店铺记录
  totalime: function totalime(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.post('/total_time.yj', params, options);
  },
  shopTodayVistors: function shopTodayVistors(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.get('/shop_today_vistors.yj', params, options);
  },
  // 意向用户
  shopAbc: function shopAbc(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.get('/shop_abc.yj', params, options);
  },
  // 添加今日访客
  addTodayVistors: function addTodayVistors(params, token) {
    if (token) {
      options.header.token = token;
    }
    return _http.default.post('/add_today_vistors.yj', params, options);
  } };var _default =
...
/* 20 */
/*!***************************************************!*\
  !*** G:/menu-food/menu-book-min/services/menu.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                        ...
                                                                                                                                                        */ // 导入http中创建的axios实例
//根服务url
var options = { baseUrl: _environment.default.SERVERURL + '/v1' };

var menu = {
  // 获取菜谱分类信息
  getCategory: function getCategory(params) {
    return _http.default.get('/category/getCategory', params, options);
  },
  // 获取菜谱列表
  getMenuList: function getMenuList(params) {
    return _http.default.get('/menu/getMenuList', params, options);
  },
  // 获取菜谱详情
  getMenuById: function getMenuById(params) {
    return _http.default.get("/menu/getMenuById/".concat(params.id), {}, options);
  },
  // 通过code获取用户信息
  getWXLogin: function getWXLogin(params) {
    return _http.default.post('/token', params, options);
  ...
  // 获取菜谱下的收藏信息
  getMenuCollect: function getMenuCollect(MenuId) {
    return _http.default.get("/menu/".concat(MenuId, "/collect"), {}, options);
  },
  // 获取菜谱下的收藏信息
  getMenuCollectList: function getMenuCollectList() {
    return _http.default.get("/menu/collect", {}, options);
  },
  // 获取菜谱下的收藏信息
  addPageViewNum: function addPageViewNum(MenuId) {
    return _http.default.get("/menu/".concat(MenuId, "/pageViewNum"), {}, options);
  } };var _default =
...
/* 21 */
/*!******************************************************!*\
  !*** G:/menu-food/menu-book-min/services/collect.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var collect = {
  /**
                 ...
                 * @param id 菜谱id
                 */
  collectMenu: function collectMenu(params) {
    return _http.default.post('/collect', params, options);
  },
  /**
      * 用户取消收藏（
      * @param id 菜谱id
      */
  cancelCollectMenu: function cancelCollectMenu(params) {
    return _http.default.post('/collect/cancel', params, options);
  } };var _default =




collect;exports.default = _default;

/***/ }),
/* 22 */
/*!***********************************************************!*\
  !*** G:/menu-food/menu-book-min/services/guessYouLike.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var menu = {
  // 获取菜谱分类信息
  guessYouLike: function guessYouLike(params) {
    return _http.default.get('/guessYouLike', params, options);
  } };var _default =
...
/* 26 */
/*!****************************************************!*\
  !*** G:/menu-food/menu-book-min/services/token.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.Token = void 0;
...
//根服务url
var options = {
  baseUrl: _environment.default.SERVERURL + '/v1' };var



Token = /*#__PURE__*/function () {
  function Token() {_classCallCheck(this, Token);
    this.verifyUrl = "".concat(options.baseUrl, "/token/verify");
    this.tokenUrl = "".concat(options.baseUrl, "/token");
    ...
    } }, { key: "onVerifyToken", value: function onVerifyToken(

    token) {var _this2 = this;
      uni.request({
        url: this.verifyUrl,
        method: 'POST',
        data: {
...
/* 30 */
/*!******************************************!*\
  !*** G:/menu-food/menu-book-min/Json.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  orderList: orderList,
  cateList: cateList,
  allFoodMenuquery: allFoodMenuquery,
  queryid: queryid };exports.default = _default;
...
/* 45 */
/*!***************************************************!*\
  !*** G:/menu-food/menu-book-min/models/basket.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.Basket = void 0;function _readOnlyError(name) {throw new Error("\"" + name + "\" is read-only");}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var Basket = /*#__PURE__*/function () {function Basket() {_classCallCheck(this, Basket);}_createClass(Basket, null, [{ key: "addIngredientsTobasket",
    // 添加食材到菜篮子中
    value: function addIngredientsTobasket(menuDetail) {
      var ingredientListInfo = uni.getStorageSync('ingredientLists') || [];
      var ingredientLists = ingredientListInfo.length > 0 ? JSON.parse(ingredientListInfo) : [];
      if (ingredientLists) {
        ingredientLists.push(menuDetail);
      } else {
        ingredientLists = (_readOnlyError("ingredientLists"), [menuDetail]);
      }
      // 获取食材信息
    ...
    // 移除到菜篮子
  }, { key: "dorpIngredientsFrombasket", value: function dorpIngredientsFrombasket(id) {
      var ingredientListInfo = JSON.parse(uni.getStorageSync('ingredientLists')) || [];
      for (var i = 0; i < ingredientListInfo.length; i++) {
    ...
    } }]);return Basket;}();exports.Basket = Basket;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
