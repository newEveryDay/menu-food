		...
		<view class="user-section">
			...
			<view class="user-info-box" @click="tologin">
				<view class="portrait-box">
					<!-- #ifdef MP-WEIXIN -->
					<view class="portrait portrait-wx">
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 获取微信登录
			getWXLogin(code, iv, encryptedData) {
				uni.getUserProfile
				var params = {
					code: code,
					iv: iv,
				...
				this.$common.$service.$user.getWXLogin(params).then(res => {
					this.token = res.data.token;
					this.getUserMemberInfo(this.token)
					this.addTodayVistors(this.token)
				})
			},
