<template>
  <div class="container">
    <zyp-card :lable="'分类列表'" :is-show-bt="false" />
    <div class="el-elem-field el-container-box">
      <el-container>
        <div class="el-elem-warp">
          <el-table :data="goodsTypeList" border style="width: 100%">
            <el-table-column fixed prop="name" label="售货机名称" width="200" />
            <el-table-column fixed prop="description" label="描述" />
            <el-table-column fixed="right" label="操作" width="120">
              <template slot-scope="scope">
                <!--                <el-button type="text" size="small">查看</el-button>-->
                <el-button type="text" size="small" @click="handleClick(scope.row)">编辑</el-button>
                <el-button type="text" size="small" @click="deletProductType(scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
...
<script>
import { getCategory, deleteProductCategory } from '@/api/goods'
